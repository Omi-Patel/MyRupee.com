                    ...
                    <div className='row'>
                        ...
                        order-lg-first order-last'>
                            ...
                            <div className='input-group mt-3'>
                                <input type='text' className='rounded-pill w-75 w-lg-75 p-2 me-3 form-control-text' placeholder='Enter Your Email' />
                        ...
                        order-md-first order-sm-first'> 
                            <img src='./images/hero.avif' alt='' className='img-fluid main-hero-img1' />
